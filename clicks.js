...
$('.three button').click(function () {
  $('.three').append($('<div>Here is some new content</div>'));
});
...
$('.five button').click(function () {
  $('.prepend-target').prepend($('main .five').clone());
});
...
$('.seven button').click(function () {
  let newButton = $('<button class="disappear">CLICK TO DISAPPEAR</button>');
  newButton.css('margin', '3px 0').css('padding', '4px');
